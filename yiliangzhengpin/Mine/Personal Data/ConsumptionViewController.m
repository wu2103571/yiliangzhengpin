...
{
    UILabel *nameL = [WZHObject LabelWithText:@"购买商品 iPhone X" font:[UIFont systemFontOfSize:16] textColor:RGBcolor(51, 51, 51) theFrame:GetFrame(15, 10, 200, 30)];
    [cell addSubview:nameL];
    
    UILabel *timeL = [WZHObject LabelWithText:@"2018-08-30 12：10" font:[UIFont systemFontOfSize:12] textColor:RGBcolor(153, 153, 153) theFrame:GetFrame(15, nameL.bottom, 200, 30)];
    [cell addSubview:timeL];
    
    UILabel *moneyL = [WZHObject LabelWithText:@"+ 8800" font:[UIFont systemFontOfSize:14] textColor:RGBcolor(51, 51, 51) theFrame:GetFrame(kScreen_width - 100, 25, 80, 30)];
